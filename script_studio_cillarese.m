...
imshow(labeloverlay(Campo_crop_esempio,BWfinal))
hold on;
s = regionprops(ndvi_crop_mask_smooth,Campo_crop_esempio_smooth,{'Centroid','WeightedCentroid'});
...
s = regionprops(ndvi_crop_mask_smooth,Campo_crop_esempio_smooth,{'Centroid','PixelValues','BoundingBox'});
%imshow(Campo_crop_esempio)
imshow(labeloverlay(Campo_crop_esempio,BWfinal))
